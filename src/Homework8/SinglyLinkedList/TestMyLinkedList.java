...
public class TestMyLinkedList {
    ...
    private static void testAdding(MyLinkedList<String> list) {
    ...
    private static void testGetting(MyLinkedList<String> list) {
    ...
    private static void testSetting(MyLinkedList<String> list) {
        System.out.printf("\n%-32s%-10s\n", "Setting elements: ", list);
        System.out.printf("%-32s%-10s\n", "  - Element @ 0: '"+list.set(0,"+")+"' -> '+'", list);
        System.out.printf("%-32s%-10s\n", "  - Element @ 2: '"+list.set(2, "-")+"' -> '-'", list);
        System.out.printf("%-32s%-10s\n", "  - Element @ 9: '"+list.set(9, "&")+"' -> '&'", list);
    }
    private static void testRemoving(MyLinkedList<String> list) {
    ...
    private static void testChecking(MyLinkedList<String> list) {
        System.out.printf("\n%-32s%-10s\n", "Checking: ", list);
